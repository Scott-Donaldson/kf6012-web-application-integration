...
* Last updated 01-Aug-2021 11:09
*
...
function climateData() {  
    ...
    $year["2021"] = array("jan"=>2.2, "feb" =>4.1, "mar"=>6.4, "apr"=>5.7,"may"=> 9.1, "jun"=>14.2, "jul"=>16.6, "aug"=>null, "sep"=>null, "oct"=>null, "nov"=>null, "dec"=>null, "av"=>null);
